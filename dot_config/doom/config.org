...
=org-roam= behaves strangely when =org-roam-dailies-directory= is assigned before
=org-roam-dailies.el= gets loaded. But our custom function needs to know path to
this directory. Setting a variable here that can be used in custom code.
#+BEGIN_SRC emacs-lisp :tangle config.el
...
#+BEGIN_SRC emacs-lisp :tangle config.el
(after! unicode-fonts
  (dolist (unicode-block '("Ancient Greek Numbers"
                           "Aegean Numbers"
                           "Ancient Symbols"
                           "Devanagari"
                           "Devanagari Extended"))
